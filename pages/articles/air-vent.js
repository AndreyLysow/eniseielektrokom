...
export default function AirVentPage() {
  return (
    <>
      <CustomHead
        title="Завоздушивание систем отопления и разграничение ответственности — Енисейэлектроком"
        ...
        keywords="завоздушивание, воздухоотводные устройства, системы отопления, разграничение ответственности, РСО, УО, Енисейэлектроком, воздушные пробки"
        ...
        ogImage="/logoetk.png"
        ogUrl="https://eniseielektrokom.ru/articles/air-vent"
      />
      <Header />
      <AirVent />
      <Footer />
